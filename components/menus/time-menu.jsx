...
const TimeMenu = ({
    ...
    const submit = async () => {
        try {
            const response = await fetch('https://pomotodolist.azurewebsites.net/api/UpdateTimeSettings?code=Kaq4s4VWew9at7w14vHo6jccxb6db4X0dOtRwubIXkGNAzFuKJ2TZg%3D%3D', {
                method: 'POST',
                headers: {
